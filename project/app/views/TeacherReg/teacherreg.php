  ...
  <div id="wrapper">
      ...
      <div id="page-content-wrapper">
          ...
          <div class="container mt-1 ">
              <form action="/daycare-pure/public/admin/newteacher">
                  <p class="pt-5">Teacher Registration</p>
                  <hr>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address 1">
                          </div>
                      </div>
