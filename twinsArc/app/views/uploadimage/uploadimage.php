...
<div id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container mt-1 ">
            <form action="/daycare-pure/public/admin/submitimagetogallery" method="post"  enctype="multipart/form-data">
                <p class="pt-5">Upload images of baby</p>
                <hr>
                ...
                <div class="row">
                    <button type="submit" name="submitbtn" id="submitbtn" class="btn btn-primary btn-lg mt-5 mx-3">Submit</button>
                </div>
